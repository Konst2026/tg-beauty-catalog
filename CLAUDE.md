...
- **Делай всё самостоятельно** — не проси пользователя делать то, что можно сделать через CLI или код.
- Устанавливай инструменты (CLI, пакеты) сам без спроса.
- Спрашивай только то, что невозможно получить без пользователя: секреты, токены, пароли, подтверждение деструктивных операций.
- Коммить и пушить изменения самостоятельно по завершении задачи — не спрашивать разрешения.
